...
export class Ryu extends Character {
    constructor(canvasWidth, canvasHeight, position = { x: 100, y: 300 }, size = { width: 100, height: 200 }, speed) {
        ...
        this.frames = new Map([
            ['standing-1',[2, 909, 62, 91]],
            ['standing-2',[67, 909, 62, 91]],
            ['standing-3',[132, 909, 62, 91]],
            ['standing-4',[198, 909, 62, 95]],
            ...
            ['forward-5',[243, 1280, 65, 90]],
            ['forward-6',[343, 1280, 65, 90]],
            ['back-1',[2, 1380, 62, 92]],
            ['back-2',[86, 1380, 62, 92]],
            ['back-3',[169, 1380, 62, 92]],
            ['back-4',[251, 1380, 62, 92]],
            ['back-5',[331, 1380, 62, 95]],
            ['back-6',[442, 1380, 62, 95]],
            ['jumping-1',[2, 1588, 55, 105]],
            ['jumping-2',[68, 1588, 55, 104]],
            ['jumping-3',[136, 1588, 55, 85]],
            ['jumping-4',[207, 1588, 55, 75]],
            ['jumping-5',[265, 1590, 51, 88]],
            ...
            ['crouch-KL-1',[69,3364,56,148]],
            ['crouch-KL-2',[41,3299,97,62]],
            ['crouch-KM-1',[169,3307,148,54]],
        ...
        this.animations = new Map([
            ...
            [characterStates.FOWARD, ['forward-1','forward-2','forward-3','forward-4','forward-5','forward-6']],
        ...
        this.attackHitboxes = new Map([
            [characterStates.LIGHT_PUNCH, {
                ...
                knockback: { x: 100, y: 0 },
                hitstun: 0.3,
                activeFrames: [1], // Frame donde está activa
